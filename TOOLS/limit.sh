#!/bin/bash
REPO="https://raw.githubusercontent.com/Diezgod/genom/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://github.com/Diezgod/genom/raw/refs/heads/main/TOOLS/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
