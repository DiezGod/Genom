...
function domain() {
    ...
    install_slowdns() {
        local script_url="https://raw.githubusercontent.com/Diezgod/genom/refs/heads/main/SLOWDNS/installsl.sh"
...
10 |10) clear ; wget -q https://github.com/Diezgod/genom/raw/refs/heads/main/install-ulang-vps && bash install-ulang-vps ;; 
11 |11) clear ; del-exp ;;
00 |0) clear ; menu ;; 
