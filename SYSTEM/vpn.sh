...
# ==================================================
# Link Hosting Kalian
SKAI0="https://raw.githubusercontent.com/Diezgod/genom/refs/heads/main/SYSTEM/"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/Diezgod/genom/refs/heads/main/SYSTEM/vpn.zip
unzip vpn.zip
rm -f vpn.zip
